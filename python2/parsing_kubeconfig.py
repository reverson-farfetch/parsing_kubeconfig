...
if __name__ == "__main__":
    ...
    *****************************************************************************************************************
    """)
    path_config_files = str(raw_input("Where are stored the kubeconfig files?[/etc/kubernetes]: ") or "/etc/kubernetes/")
    path_to_save_kubeconfig = str(raw_input("Where do want to save the kubeconfig file?[~/.kube/config]: ") or home+"/.kube/config")
    prefix = str(raw_input("Do you want to change the default prefix?[*-config]: ") or "*-config")
